...
UI/UX Design for a photographer's/videographer's portfolio home page (press the audio button when video plays for sound experience). Front-end created with React and Gatsby on the backend.
